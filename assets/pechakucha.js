...
Elm.Monocle = Elm.Monocle || {};
Elm.Monocle.Iso = Elm.Monocle.Iso || {};
Elm.Monocle.Iso.make = function (_elm) {
   "use strict";
   _elm.Monocle = _elm.Monocle || {};
   _elm.Monocle.Iso = _elm.Monocle.Iso || {};
   if (_elm.Monocle.Iso.values) return _elm.Monocle.Iso.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var modify = F2(function (iso,f) {    return function (_p0) {    return iso.reverseGet(f(iso.get(_p0)));};});
   var Iso = F2(function (a,b) {    return {get: a,reverseGet: b};});
   var reverse = function (iso) {    return A2(Iso,iso.reverseGet,iso.get);};
   var compose = F2(function (outer,inner) {
      return A2(Iso,function (_p1) {    return inner.get(outer.get(_p1));},function (_p2) {    return outer.reverseGet(inner.reverseGet(_p2));});
   });
   return _elm.Monocle.Iso.values = {_op: _op,reverse: reverse,modify: modify,compose: compose,Iso: Iso};
};
Elm.Monocle = Elm.Monocle || {};
Elm.Monocle.Lens = Elm.Monocle.Lens || {};
Elm.Monocle.Lens.make = function (_elm) {
   "use strict";
   _elm.Monocle = _elm.Monocle || {};
   _elm.Monocle.Lens = _elm.Monocle.Lens || {};
   if (_elm.Monocle.Lens.values) return _elm.Monocle.Lens.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Monocle$Iso = Elm.Monocle.Iso.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var modifyAndMerge = F3(function (lens,fx,merge) {
      var mf = function (_p0) {
         var _p1 = _p0;
         var _p4 = _p1._0;
         return function (_p2) {
            var _p3 = _p2;
            return {ctor: "_Tuple2",_0: A2(lens.set,_p3._0,_p4),_1: A2(merge,_p1._1,_p3._1)};
         }(fx(lens.get(_p4)));
      };
      return mf;
   });
   var modify = F2(function (lens,f) {    var mf = function (a) {    return function (b) {    return A2(lens.set,b,a);}(f(lens.get(a)));};return mf;});
   var Lens = F2(function (a,b) {    return {get: a,set: b};});
   var compose = F2(function (outer,inner) {
      var set = F2(function (c,a) {    return function (b) {    return A2(outer.set,b,a);}(A2(inner.set,c,outer.get(a)));});
      return A2(Lens,function (_p5) {    return inner.get(outer.get(_p5));},set);
   });
   var fromIso = function (iso) {    var set = F2(function (b,_p6) {    return iso.reverseGet(b);});return A2(Lens,iso.get,set);};
   var zip = F2(function (left,right) {
      var set = F2(function (_p8,_p7) {
         var _p9 = _p8;
         var _p10 = _p7;
         return {ctor: "_Tuple2",_0: A2(left.set,_p9._0,_p10._0),_1: A2(right.set,_p9._1,_p10._1)};
      });
      var get = function (_p11) {    var _p12 = _p11;return {ctor: "_Tuple2",_0: left.get(_p12._0),_1: right.get(_p12._1)};};
      return A2(Lens,get,set);
   });
...
Elm.PechaKucha.PageType1.make = function (_elm) {
   ...
   var update = F2(function (message,model) {
      var _p0 = message;
      switch (_p0.ctor)
      {case "Tick": return {ctor: "_Tuple2",_0: _U.update(model,{frame: model.frame + 1}),_1: $Effects.none};
         case "Scene": return {ctor: "_Tuple2",_0: _U.update(model,{scene: _p0._0}),_1: $Effects.none};
         default: return {ctor: "_Tuple2",_0: model,_1: $Effects.none};}
   });
   var Model = F2(function (a,b) {    return {scene: a,frame: b};});
   var init = {ctor: "_Tuple2",_0: A2(Model,0,0),_1: $Effects.none};
   return _elm.PechaKucha.PageType1.values = {_op: _op,Model: Model,init: init,update: update};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page01 = Elm.PechaKucha.Page01 || {};
Elm.PechaKucha.Page01.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var update = $PechaKucha$PageType1.update;
   ...
   _U.list([$Html.text("is functional")]));
   var scene0 = A2($Html.div,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("About Elm ...")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
         case 2: return A2($Html.div,_U.list([]),_U.list([scene0,scene1,scene2]));
         case 3: return A2($Html.div,_U.list([]),_U.list([scene0,scene1,scene2,scene3]));
         case 4: return A2($Html.div,_U.list([]),_U.list([scene0,scene1,scene2,scene3,scene4]));
         default: return A2($Html.div,_U.list([]),_U.list([scene0]));}
   });
   return _elm.PechaKucha.Page01.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page02 = Elm.PechaKucha.Page02 || {};
Elm.PechaKucha.Page02.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var scene4 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene4 blue animated fadeIn"),$Html$Attributes.key("s0.4")]),
   _U.list([$Html.text("refactor and debug")]));
   var scene3 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene3 pink animated fadeIn"),$Html$Attributes.key("s0.3")]),
   _U.list([$Html.text("easy to test")]));
   var scene2 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene2 green  animated fadeIn"),$Html$Attributes.key("s0.2")]),
   _U.list([$Html.text("nicely modular")]));
   var scene1 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene1 orange animated fadeIn"),$Html$Attributes.key("s0.1")]),
   _U.list([$Html.text("shockingly fast")]));
   var scene0 = A2($Html.div,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("Elm promises")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
   ...
   return _elm.PechaKucha.Page02.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page03 = Elm.PechaKucha.Page03 || {};
Elm.PechaKucha.Page03.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var scene4 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene4 blue animated fadeIn"),$Html$Attributes.key("s0.4")]),
   _U.list([$Html.text("apply, pass or compose")]));
   var scene3 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene3 pink animated fadeIn"),$Html$Attributes.key("s0.3")]),
   _U.list([$Html.text("function is a value")]));
   var scene2 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene2 green  animated fadeIn"),$Html$Attributes.key("s0.2")]),
   ...
   return _elm.PechaKucha.Page03.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page04 = Elm.PechaKucha.Page04 || {};
Elm.PechaKucha.Page04.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var scene4 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene4 blue animated fadeIn"),$Html$Attributes.key("s0.4")]),
   _U.list([$Html.text("you emit new data")]));
   var scene3 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene3 pink animated fadeIn"),$Html$Attributes.key("s0.3")]),
   _U.list([$Html.text("you transform them")]));
   var scene2 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene2 green  animated fadeIn"),$Html$Attributes.key("s0.2")]),
   _U.list([$Html.text("you merge/fork them")]));
   var scene1 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene1 orange animated fadeIn"),$Html$Attributes.key("s0.1")]),
   _U.list([$Html.text("data keep flowing")]));
   var scene0 = A2($Html.div,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("Elm is reactive")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
   ...
   return _elm.PechaKucha.Page04.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page05 = Elm.PechaKucha.Page05 || {};
Elm.PechaKucha.Page05.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var scene4 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene4 blue animated fadeIn"),$Html$Attributes.key("s0.4")]),
   _U.list([$Html.text("modular design")]));
   var scene3 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene3 pink animated fadeIn"),$Html$Attributes.key("s0.3")]),
   _U.list([$Html.text("pattern matching")]));
   var scene2 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene2 green  animated fadeIn"),$Html$Attributes.key("s0.2")]),
   _U.list([$Html.text("stateless functions")]));
   var scene1 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene1 orange animated fadeIn"),$Html$Attributes.key("s0.1")]),
   _U.list([$Html.text("strong typing")]));
   var scene0 = A2($Html.div,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("Elm language got")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
   ...
   return _elm.PechaKucha.Page05.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page06 = Elm.PechaKucha.Page06 || {};
Elm.PechaKucha.Page06.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var scene4 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene4 blue animated fadeIn"),$Html$Attributes.key("s0.4")]),
   _U.list([$Html.text("exceptions")]));
   var scene3 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene3 pink animated fadeIn"),$Html$Attributes.key("s0.3")]),
   _U.list([$Html.text("null values")]));
   var scene2 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene2 green  animated fadeIn"),$Html$Attributes.key("s0.2")]),
   _U.list([$Html.text("statements")]));
   var scene1 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene1 orange animated fadeIn"),$Html$Attributes.key("s0.1")]),
   _U.list([$Html.text("variables")]));
   var scene0 = A2($Html.div,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("Elm lang got not")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
   ...
   return _elm.PechaKucha.Page06.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page07 = Elm.PechaKucha.Page07 || {};
Elm.PechaKucha.Page07.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var init = $PechaKucha$PageType1.init;
   var scene4 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene4 blue small animated fadeIn"),$Html$Attributes.key("s0.4")]),
   _U.list([$Html.text("main = Signal.map renderHtml Mouse.position")]));
   var scene3 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene3 pink small animated fadeIn"),$Html$Attributes.key("s0.3")]),
   _U.list([$Html.text("renderHtml (x,y) = div [left (toString x)][text (toString y)]")]));
   var scene2 = A2($Html.span,_U.list([$Html$Attributes.$class("scene2 green animated fadeIn"),$Html$Attributes.key("s0.2")]),_U.list([$Html.text(" Html")]));
   var scene1 = A2($Html.span,
   _U.list([$Html$Attributes.$class("scene1 orange animated fadeIn"),$Html$Attributes.key("s0.1")]),
   _U.list([$Html.text(": Signal")]));
   var scene0 = A2($Html.span,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("main")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
   ...
   return _elm.PechaKucha.Page07.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page08 = Elm.PechaKucha.Page08 || {};
Elm.PechaKucha.Page08.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var init = $PechaKucha$PageType1.init;
   var scene4 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene4 blue offset animated fadeIn"),$Html$Attributes.key("s0.4")]),
   _U.list([$Html.text(", signal : Signal a }")]));
   var scene3 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene3 pink offset animated fadeIn"),$Html$Attributes.key("s0.3")]),
   _U.list([$Html.text("{ address : Address a")]));
   var scene2 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene2 green animated fadeIn"),$Html$Attributes.key("s0.2")]),
   _U.list([$Html.text("type alias Mailbox a =")]));
   var scene1 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene1 orange animated fadeIn"),$Html$Attributes.key("s0.1")]),
   _U.list([$Html.text("type Address a")]));
   var scene0 = A2($Html.div,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("type Signal a")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
   ...
   return _elm.PechaKucha.Page08.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page09 = Elm.PechaKucha.Page09 || {};
Elm.PechaKucha.Page09.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var init = $PechaKucha$PageType1.init;
   var scene4 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene4 medium blue animated fadeIn"),$Html$Attributes.key("s0.4")]),
   _U.list([$Html.text("to outputs that handle stuff")]));
   var scene3 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene3 medium pink animated fadeIn"),$Html$Attributes.key("s0.3")]),
   _U.list([$Html.text("propagate through network")]));
   var scene2 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene2 medium green animated fadeIn"),$Html$Attributes.key("s0.2")]),
   _U.list([$Html.text("inputs receive messages")]));
   var scene1 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene1 medium orange animated fadeIn"),$Html$Attributes.key("s0.1")]),
   _U.list([$Html.text("static processing network")]));
   var scene0 = A2($Html.div,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("Signals sets up")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
   ...
   return _elm.PechaKucha.Page09.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page10 = Elm.PechaKucha.Page10 || {};
Elm.PechaKucha.Page10.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var scene4 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene4 medium blue animated fadeIn"),$Html$Attributes.key("s0.4")]),
   _U.list([$Html.text("incoming and outgoing events")]));
   var scene3 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene3 medium pink animated fadeIn"),$Html$Attributes.key("s0.3")]),
   _U.list([$Html.text("use signals to route there")]));
   var scene2 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene2 medium green animated fadeIn"),$Html$Attributes.key("s0.2")]),
   _U.list([$Html.text("lives in the foldp function")]));
   var scene1 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene1 medium orange animated fadeIn"),$Html$Attributes.key("s0.1")]),
   _U.list([$Html.text("single global state/model")]));
   var scene0 = A2($Html.div,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("Where is state?")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
   ...
   return _elm.PechaKucha.Page10.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page11 = Elm.PechaKucha.Page11 || {};
Elm.PechaKucha.Page11.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var init = $PechaKucha$PageType1.init;
   var scene4 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene4 offset blue animated fadeIn"),$Html$Attributes.key("s0.4")]),
   _U.list([$Html.text(" -> Signal s")]));
   var scene3 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene3 offset pink animated fadeIn"),$Html$Attributes.key("s0.3")]),
   _U.list([$Html.text(" -> Signal a")]));
   var scene2 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene2 offset green animated fadeIn"),$Html$Attributes.key("s0.2")]),
   _U.list([$Html.text(" -> s")]));
   var scene1 = A2($Html.span,
   _U.list([$Html$Attributes.$class("scene1 orange animated fadeIn"),$Html$Attributes.key("s0.1")]),
   _U.list([$Html.text(": (a -> s -> s)")]));
   var scene0 = A2($Html.span,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("foldp")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
   ...
   return _elm.PechaKucha.Page11.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page12 = Elm.PechaKucha.Page12 || {};
Elm.PechaKucha.Page12.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var scene4 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene4 blue animated fadeIn"),$Html$Attributes.key("s0.4")]),
   _U.list([$Html.text("code reuse and testing")]));
   var scene3 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene3 pink animated fadeIn"),$Html$Attributes.key("s0.3")]),
   _U.list([$Html.text("great for modularity")]));
   var scene2 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene2 green  animated fadeIn"),$Html$Attributes.key("s0.2")]),
   _U.list([$Html.text("nestable components")]));
   var scene1 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene1 orange animated fadeIn"),$Html$Attributes.key("s0.1")]),
   _U.list([$Html.text("a simple pattern for")]));
   var scene0 = A2($Html.div,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("Elm architecture")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
   ...
   return _elm.PechaKucha.Page12.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page13 = Elm.PechaKucha.Page13 || {};
Elm.PechaKucha.Page13.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var scene4 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene4 blue animated fadeIn"),$Html$Attributes.key("s0.4")]),
   _U.list([$Html.text("this is the essence")]));
   var scene3 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene3 pink animated fadeIn"),$Html$Attributes.key("s0.3")]),
   _U.list([$Html.text("model, update and view")]));
   var scene2 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene2 green  animated fadeIn"),$Html$Attributes.key("s0.2")]),
   _U.list([$Html.text("cleanly separated parts")]));
   var scene1 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene1 orange animated fadeIn"),$Html$Attributes.key("s0.1")]),
   _U.list([$Html.text("breaks up into three")]));
   var scene0 = A2($Html.div,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("Logic of elm app")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
   ...
   return _elm.PechaKucha.Page13.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page14 = Elm.PechaKucha.Page14 || {};
Elm.PechaKucha.Page14.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var scene4 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene4 offset blue animated fadeIn"),$Html$Attributes.key("s0.4")]),
   _U.list([$Html.text(" , Effects action)")]));
   var scene3 = A2($Html.span,_U.list([$Html$Attributes.$class("scene3 pink animated fadeIn"),$Html$Attributes.key("s0.3")]),_U.list([$Html.text(": (model")]));
   var scene2 = A2($Html.span,_U.list([$Html$Attributes.$class("scene2 green animated fadeIn"),$Html$Attributes.key("s0.2")]),_U.list([$Html.text("init")]));
   var scene1 = A2($Html.span,
   _U.list([$Html$Attributes.$class("scene1 orange animated fadeIn"),$Html$Attributes.key("s0.1")]),
   _U.list([$Html.text(" { ... }")]));
   var scene0 = A2($Html.span,
   _U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),
   _U.list([A2($Html.span,_U.list([$Html$Attributes.$class("midi")]),_U.list([$Html.text("type alias ")]))
           ,A2($Html.span,_U.list([]),_U.list([$Html.text("Model")]))
           ,A2($Html.span,_U.list([$Html$Attributes.$class("medium")]),_U.list([$Html.text(" =")]))]));
   var scene00 = A2($Html.div,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("model")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
         case 2: return A2($Html.div,_U.list([]),_U.list([scene0,scene1,A2($Html.div,_U.list([]),_U.list([scene2]))]));
         case 3: return A2($Html.div,_U.list([]),_U.list([scene0,scene1,A2($Html.div,_U.list([]),_U.list([scene2,scene3]))]));
         case 4: return A2($Html.div,_U.list([]),_U.list([scene0,scene1,A2($Html.div,_U.list([]),_U.list([scene2,scene3,scene4]))]));
         default: return A2($Html.div,_U.list([]),_U.list([scene00]));}
   });
   return _elm.PechaKucha.Page14.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page15 = Elm.PechaKucha.Page15 || {};
Elm.PechaKucha.Page15.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var scene2 = A2($Html.span,
   _U.list([$Html$Attributes.$class("scene2 green  animated fadeIn"),$Html$Attributes.key("s0.2")]),
   _U.list([$Html.text(" -> model")]));
   var scene1 = A2($Html.span,
   _U.list([$Html$Attributes.$class("scene1 orange animated fadeIn"),$Html$Attributes.key("s0.1")]),
   _U.list([$Html.text(": action")]));
   var scene0 = A2($Html.span,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("update")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
   ...
   return _elm.PechaKucha.Page15.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page16 = Elm.PechaKucha.Page16 || {};
Elm.PechaKucha.Page16.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var init = $PechaKucha$PageType1.init;
   var scene4 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene4 small blue animated fadeIn"),$Html$Attributes.key("s0.4")]),
   _U.list([$Html.text("type alias Html = VirtualDom.Node")]));
   var scene3 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene3 offset pink animated fadeIn"),$Html$Attributes.key("s0.3")]),
   _U.list([$Html.text(" -> Html")]));
   var scene2 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene2 offset green animated fadeIn"),$Html$Attributes.key("s0.2")]),
   _U.list([$Html.text(" -> model")]));
   var scene1 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene1 offset orange animated fadeIn"),$Html$Attributes.key("s0.1")]),
   _U.list([$Html.text("Signal.Address action")]));
   var scene0 = A2($Html.div,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("view : ")]));
   var scene00 = A2($Html.div,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("view")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
   ...
   return _elm.PechaKucha.Page16.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page17 = Elm.PechaKucha.Page17 || {};
Elm.PechaKucha.Page17.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var scene4 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene4 small blue animated fadeIn"),$Html$Attributes.key("s0.4")]),
   _U.list([$Html.text("start : Config model action -> App model")]));
   var scene3 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene3 offset pink animated fadeIn"),$Html$Attributes.key("s0.3")]),
   _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text(", tasks")]))
           ,A2($Html.span,_U.list([$Html$Attributes.$class("midi")]),_U.list([$Html.text(" : Signal (Task ...) }")]))]));
   var scene2 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene2 offset green  animated fadeIn"),$Html$Attributes.key("s0.2")]),
   _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text(", model")]))
           ,A2($Html.span,_U.list([$Html$Attributes.$class("midi")]),_U.list([$Html.text(" : Signal model")]))]));
   var scene1 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene1 offset orange animated fadeIn"),$Html$Attributes.key("s0.1")]),
   _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text("{ html")]))
           ,A2($Html.span,_U.list([$Html$Attributes.$class("midi")]),_U.list([$Html.text(" : Signal Html")]))]));
   var scene0 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),
   _U.list([A2($Html.span,_U.list([$Html$Attributes.$class("midi")]),_U.list([$Html.text("type alias ")]))
           ,A2($Html.span,_U.list([]),_U.list([$Html.text("App")]))
           ,A2($Html.span,_U.list([$Html$Attributes.$class("medium")]),_U.list([$Html.text(" model =")]))]));
   var scene00 = A2($Html.div,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("app")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
   ...
   return _elm.PechaKucha.Page17.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page18 = Elm.PechaKucha.Page18 || {};
Elm.PechaKucha.Page18.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var scene4 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene4 offset blue animated fadeIn"),$Html$Attributes.key("s0.4")]),
   _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text(", inputs")]))
           ,A2($Html.span,_U.list([$Html$Attributes.$class("tiny")]),_U.list([$Html.text(" : List (Signal.Signal action) }")]))]));
   var scene3 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene3 offset pink animated fadeIn"),$Html$Attributes.key("s0.3")]),
   _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text(", view")]))
           ,A2($Html.span,_U.list([$Html$Attributes.$class("tiny")]),_U.list([$Html.text(" : Signal.Address action -> model -> Html")]))]));
   var scene2 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene2 offset green  animated fadeIn"),$Html$Attributes.key("s0.2")]),
   _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text(", update")]))
           ,A2($Html.span,_U.list([$Html$Attributes.$class("tiny")]),_U.list([$Html.text(" : action -> model -> (model, Effects action)")]))]));
   var scene1 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene1 offset orange animated fadeIn"),$Html$Attributes.key("s0.1")]),
   _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text("{ init")]))
           ,A2($Html.span,_U.list([$Html$Attributes.$class("tiny")]),_U.list([$Html.text(" : (model, Effects action)")]))]));
   var scene0 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),
   _U.list([A2($Html.span,_U.list([$Html$Attributes.$class("midi")]),_U.list([$Html.text("type alias ")]))
           ,A2($Html.span,_U.list([]),_U.list([$Html.text("Config")]))
           ,A2($Html.span,_U.list([$Html$Attributes.$class("medium")]),_U.list([$Html.text(" model action =")]))]));
   var scene00 = A2($Html.div,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("config")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
   ...
   return _elm.PechaKucha.Page18.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page19 = Elm.PechaKucha.Page19 || {};
Elm.PechaKucha.Page19.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   var scene4 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene4 blue animated fadeIn"),$Html$Attributes.key("s0.4")]),
   _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text("port tasks = ")]))
           ,A2($Html.span,_U.list([$Html$Attributes.$class("medium")]),_U.list([$Html.text("app.tasks")]))]));
   var scene3 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene3 pink animated fadeIn"),$Html$Attributes.key("s0.3")]),
   _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text("main = ")]))
           ,A2($Html.span,_U.list([$Html$Attributes.$class("medium")]),_U.list([$Html.text("app.html")]))]));
   var scene2 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene2 medium offset green  animated fadeIn"),$Html$Attributes.key("s0.2")]),
   _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text(", view = ... , inputs = ... }")]))
           ,A2($Html.span,_U.list([$Html$Attributes.$class("tiny")]),_U.list([$Html.text("")]))]));
   var scene1 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene1 medium offset orange animated fadeIn"),$Html$Attributes.key("s0.1")]),
   _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text(" { init = ... , update = ...")]))
           ,A2($Html.span,_U.list([$Html$Attributes.$class("tiny")]),_U.list([$Html.text("")]))]));
   var scene0 = A2($Html.div,
   _U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),
   _U.list([A2($Html.span,_U.list([$Html$Attributes.$class("midi")]),_U.list([$Html.text("")]))
           ,A2($Html.span,_U.list([]),_U.list([$Html.text("app = ")]))
           ,A2($Html.span,_U.list([$Html$Attributes.$class("medium")]),_U.list([$Html.text("StartApp.start")]))]));
   var scene00 = A2($Html.div,_U.list([$Html$Attributes.$class("scene0"),$Html$Attributes.key("s0.0")]),_U.list([$Html.text("hello world!")]));
   var view = F2(function (address,model) {
      var _p0 = model.scene;
      switch (_p0)
      {case 1: return A2($Html.div,_U.list([]),_U.list([scene0,scene1]));
   ...
   return _elm.PechaKucha.Page19.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Page20 = Elm.PechaKucha.Page20 || {};
Elm.PechaKucha.Page20.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   return _elm.PechaKucha.Page20.values = {_op: _op,init: init,update: update,view: view};
};
Elm.PechaKucha = Elm.PechaKucha || {};
Elm.PechaKucha.Pages = Elm.PechaKucha.Pages || {};
Elm.PechaKucha.Pages.make = function (_elm) {
   "use strict";
   _elm.PechaKucha = _elm.PechaKucha || {};
   ...
   $PechaKucha$Page04 = Elm.PechaKucha.Page04.make(_elm),
   $PechaKucha$Page05 = Elm.PechaKucha.Page05.make(_elm),
   $PechaKucha$Page06 = Elm.PechaKucha.Page06.make(_elm),
   $PechaKucha$Page07 = Elm.PechaKucha.Page07.make(_elm),
   $PechaKucha$Page08 = Elm.PechaKucha.Page08.make(_elm),
   $PechaKucha$Page09 = Elm.PechaKucha.Page09.make(_elm),
   $PechaKucha$Page10 = Elm.PechaKucha.Page10.make(_elm),
   $PechaKucha$Page11 = Elm.PechaKucha.Page11.make(_elm),
   $PechaKucha$Page12 = Elm.PechaKucha.Page12.make(_elm),
   $PechaKucha$Page13 = Elm.PechaKucha.Page13.make(_elm),
   $PechaKucha$Page14 = Elm.PechaKucha.Page14.make(_elm),
   $PechaKucha$Page15 = Elm.PechaKucha.Page15.make(_elm),
   $PechaKucha$Page16 = Elm.PechaKucha.Page16.make(_elm),
   $PechaKucha$Page17 = Elm.PechaKucha.Page17.make(_elm),
   $PechaKucha$Page18 = Elm.PechaKucha.Page18.make(_elm),
   $PechaKucha$Page19 = Elm.PechaKucha.Page19.make(_elm),
   $PechaKucha$Page20 = Elm.PechaKucha.Page20.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var viewPage = F4(function (lens,view,address,model) {    return A2(view,address,lens.get(model));});
   var updatePage = F4(function (lens,update,action,model) {
      return function (_p0) {
         var _p1 = _p0;
         return {ctor: "_Tuple2",_0: A2(lens.set,_p1._0,model),_1: _p1._1};
      }(A2(update,action,lens.get(model)));
   });
   var page20Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page20;},F2(function (x,m) {    return _U.update(m,{page20: x});}));
   var page19Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page19;},F2(function (x,m) {    return _U.update(m,{page19: x});}));
   var page18Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page18;},F2(function (x,m) {    return _U.update(m,{page18: x});}));
   var page17Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page17;},F2(function (x,m) {    return _U.update(m,{page17: x});}));
   var page16Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page16;},F2(function (x,m) {    return _U.update(m,{page16: x});}));
   var page15Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page15;},F2(function (x,m) {    return _U.update(m,{page15: x});}));
   var page14Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page14;},F2(function (x,m) {    return _U.update(m,{page14: x});}));
   var page13Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page13;},F2(function (x,m) {    return _U.update(m,{page13: x});}));
   var page12Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page12;},F2(function (x,m) {    return _U.update(m,{page12: x});}));
   var page11Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page11;},F2(function (x,m) {    return _U.update(m,{page11: x});}));
   var page10Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page10;},F2(function (x,m) {    return _U.update(m,{page10: x});}));
   var page09Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page09;},F2(function (x,m) {    return _U.update(m,{page09: x});}));
   var page08Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page08;},F2(function (x,m) {    return _U.update(m,{page08: x});}));
   var page07Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page07;},F2(function (x,m) {    return _U.update(m,{page07: x});}));
   var page06Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page06;},F2(function (x,m) {    return _U.update(m,{page06: x});}));
   var page05Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page05;},F2(function (x,m) {    return _U.update(m,{page05: x});}));
   var page04Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page04;},F2(function (x,m) {    return _U.update(m,{page04: x});}));
   var page03Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page03;},F2(function (x,m) {    return _U.update(m,{page03: x});}));
   var page02Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page02;},F2(function (x,m) {    return _U.update(m,{page02: x});}));
   var page01Lens = A2($Monocle$Lens.Lens,function (_) {    return _.page01;},F2(function (x,m) {    return _U.update(m,{page01: x});}));
   var updatePageN = function (index) {
      var _p2 = index + 1;
      switch (_p2)
      {case 1: return A2(updatePage,page01Lens,$PechaKucha$Page01.update);
         case 2: return A2(updatePage,page02Lens,$PechaKucha$Page02.update);
         case 3: return A2(updatePage,page03Lens,$PechaKucha$Page03.update);
         case 4: return A2(updatePage,page04Lens,$PechaKucha$Page04.update);
         case 5: return A2(updatePage,page05Lens,$PechaKucha$Page05.update);
         case 6: return A2(updatePage,page06Lens,$PechaKucha$Page06.update);
         case 7: return A2(updatePage,page07Lens,$PechaKucha$Page07.update);
         case 8: return A2(updatePage,page08Lens,$PechaKucha$Page08.update);
         case 9: return A2(updatePage,page09Lens,$PechaKucha$Page09.update);
         case 10: return A2(updatePage,page10Lens,$PechaKucha$Page10.update);
         case 11: return A2(updatePage,page11Lens,$PechaKucha$Page11.update);
         case 12: return A2(updatePage,page12Lens,$PechaKucha$Page12.update);
         case 13: return A2(updatePage,page13Lens,$PechaKucha$Page13.update);
         case 14: return A2(updatePage,page14Lens,$PechaKucha$Page14.update);
         case 15: return A2(updatePage,page15Lens,$PechaKucha$Page15.update);
         case 16: return A2(updatePage,page16Lens,$PechaKucha$Page16.update);
         case 17: return A2(updatePage,page17Lens,$PechaKucha$Page17.update);
         case 18: return A2(updatePage,page18Lens,$PechaKucha$Page18.update);
         case 19: return A2(updatePage,page19Lens,$PechaKucha$Page19.update);
         default: return A2(updatePage,page20Lens,$PechaKucha$Page20.update);}
   };
   var update = F2(function (action,model) {    return A3(updatePageN,model.currentPageIndex,action,model);});
   var viewPageN = function (index) {
      var _p3 = index + 1;
      switch (_p3)
      {case 1: return A2(viewPage,page01Lens,$PechaKucha$Page01.view);
         case 2: return A2(viewPage,page02Lens,$PechaKucha$Page02.view);
         case 3: return A2(viewPage,page03Lens,$PechaKucha$Page03.view);
         case 4: return A2(viewPage,page04Lens,$PechaKucha$Page04.view);
         case 5: return A2(viewPage,page05Lens,$PechaKucha$Page05.view);
         case 6: return A2(viewPage,page06Lens,$PechaKucha$Page06.view);
         case 7: return A2(viewPage,page07Lens,$PechaKucha$Page07.view);
         case 8: return A2(viewPage,page08Lens,$PechaKucha$Page08.view);
         case 9: return A2(viewPage,page09Lens,$PechaKucha$Page09.view);
         case 10: return A2(viewPage,page10Lens,$PechaKucha$Page10.view);
         case 11: return A2(viewPage,page11Lens,$PechaKucha$Page11.view);
         case 12: return A2(viewPage,page12Lens,$PechaKucha$Page12.view);
         case 13: return A2(viewPage,page13Lens,$PechaKucha$Page13.view);
         case 14: return A2(viewPage,page14Lens,$PechaKucha$Page14.view);
         case 15: return A2(viewPage,page15Lens,$PechaKucha$Page15.view);
         case 16: return A2(viewPage,page16Lens,$PechaKucha$Page16.view);
         case 17: return A2(viewPage,page17Lens,$PechaKucha$Page17.view);
         case 18: return A2(viewPage,page18Lens,$PechaKucha$Page18.view);
         case 19: return A2(viewPage,page19Lens,$PechaKucha$Page19.view);
         default: return A2(viewPage,page20Lens,$PechaKucha$Page20.view);}
   };
   var view = F2(function (address,model) {    return A3(viewPageN,model.currentPageIndex,address,model);});
   var indexLens = A2($Monocle$Lens.Lens,function (_) {    return _.currentPageIndex;},F2(function (x,m) {    return _U.update(m,{currentPageIndex: x});}));
   var init = function () {
      var _p4 = $PechaKucha$Page20.init;
      var page20 = _p4._0;
      var e20 = _p4._1;
      var _p5 = $PechaKucha$Page19.init;
      var page19 = _p5._0;
      var e19 = _p5._1;
      var _p6 = $PechaKucha$Page18.init;
      var page18 = _p6._0;
      var e18 = _p6._1;
      var _p7 = $PechaKucha$Page17.init;
      var page17 = _p7._0;
      var e17 = _p7._1;
      var _p8 = $PechaKucha$Page16.init;
      var page16 = _p8._0;
      var e16 = _p8._1;
      var _p9 = $PechaKucha$Page15.init;
      var page15 = _p9._0;
      var e15 = _p9._1;
      var _p10 = $PechaKucha$Page14.init;
      var page14 = _p10._0;
      var e14 = _p10._1;
      var _p11 = $PechaKucha$Page13.init;
      var page13 = _p11._0;
      var e13 = _p11._1;
      var _p12 = $PechaKucha$Page12.init;
      var page12 = _p12._0;
      var e12 = _p12._1;
      var _p13 = $PechaKucha$Page11.init;
      var page11 = _p13._0;
      var e11 = _p13._1;
      var _p14 = $PechaKucha$Page10.init;
      var page10 = _p14._0;
      var e10 = _p14._1;
      var _p15 = $PechaKucha$Page09.init;
      var page09 = _p15._0;
      var e09 = _p15._1;
      var _p16 = $PechaKucha$Page08.init;
      var page08 = _p16._0;
      var e08 = _p16._1;
      var _p17 = $PechaKucha$Page07.init;
      var page07 = _p17._0;
      var e07 = _p17._1;
      var _p18 = $PechaKucha$Page06.init;
      var page06 = _p18._0;
      var e06 = _p18._1;
      var _p19 = $PechaKucha$Page05.init;
      var page05 = _p19._0;
      var e05 = _p19._1;
      var _p20 = $PechaKucha$Page04.init;
      var page04 = _p20._0;
      var e04 = _p20._1;
      var _p21 = $PechaKucha$Page03.init;
      var page03 = _p21._0;
      var e03 = _p21._1;
      var _p22 = $PechaKucha$Page02.init;
      var page02 = _p22._0;
      var e02 = _p22._1;
      var _p23 = $PechaKucha$Page01.init;
      var page01 = _p23._0;
      var e01 = _p23._1;
      return {ctor: "_Tuple2"
             ,_0: {currentPageIndex: 0
                  ,page01: page01
                  ,page02: page02
                  ,page03: page03
                  ,page04: page04
                  ...
                  ,page19: page19
                  ,page20: page20}
             ,_1: $Effects.batch(_U.list([e01,e02,e03,e04,e05,e06,e07,e08,e09,e10,e11,e12,e13,e14,e15,e16,e17,e18,e19,e20]))};
   }();
   ...
   var maxPageIndex = 19;
   var minPageIndex = 0;
   return _elm.PechaKucha.Pages.values = {_op: _op
                                         ,init: init
                                         ,update: update
                                         ,view: view
                                         ,indexLens: indexLens
...
Elm.PechaKucha.make = function (_elm) {
   ...
   _op[">>>"] = F2(function (left,right) {
      var merge = F2(function (e1,_p2) {    var _p3 = _p2;return {ctor: "_Tuple2",_0: _p3._0,_1: A2(mergeEffects,e1,_p3._1)};});
      var r = function (_p4) {    var _p5 = _p4;return A2(merge,_p5._1,right(_p5._0));};
      var l = function (model) {    return r(left(model));};
      return l;
   });
   _op["|>>"] = F2(function (init,right) {
      var merge = F2(function (e1,_p6) {    var _p7 = _p6;return {ctor: "_Tuple2",_0: _p7._0,_1: A2(mergeEffects,e1,_p7._1)};});
      var r = function (_p8) {    var _p9 = _p8;return A2(merge,_p9._1,right(_p9._0));};
      return r(init);
   });
...
Elm.Tests.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var all = A2($ElmTest.suite,"A PechaKucha test suite",_U.list([]));
...
Elm.TestRunner.make = function (_elm) {
   ...
   return _elm.TestRunner.values = {_op: _op,console: console};
};
