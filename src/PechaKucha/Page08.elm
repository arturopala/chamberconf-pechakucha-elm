module PechaKucha.Page08 (Model, init, update, view) where
...
scene2 =
    div
        ...
        [ text "type alias Mailbox a =" ]


scene3 : Html
scene3 =
    div
        [ class "scene3 pink offset animated fadeIn", key "s0.3" ]
        [ text "{ address : Address a" ]


scene4 : Html
scene4 =
    div
        [ class "scene4 blue offset animated fadeIn", key "s0.4" ]
        [ text ", signal : Signal a }" ]
